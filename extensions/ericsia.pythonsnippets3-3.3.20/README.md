### Best Python3 Snippets Pack (2024) for Visual Studio Code (python 3.x)
...
### 3.3.20
added back `.` prefix to fix double dot issue by DocLock17 and Region snippet by livan3li
-----------------------------------------------------------------------------------------------------------